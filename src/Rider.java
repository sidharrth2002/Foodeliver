...
//
//            System.out.println("=======================");
//            System.out.println("Select 1 to view your turn and currently assigned orders");
//            System.out.println("Select anything else to view order history");
//            System.out.println("=======================");
//            System.out.println("Input:");
//            String inputr2 = input.nextLine();
//
...
//                        orders.addAll(restaurants.get(i).getOrderHistory());
//                    }
//                    System.out.println(restaurants.get(0).getOrderHistory().size() + restaurants.get(1).getOrderHistory().size() + restaurants.get(2).getOrderHistory().size());
